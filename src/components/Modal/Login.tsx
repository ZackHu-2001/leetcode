...
const Login: React.FC<LoginProps> = () => {
    ...
    return <form action="" className=' space-y-6 px-6 py-4'>
        <h3 className='text-xl font-medium'>Sign in to LeetCode</h3>
        <div>
            <label htmlFor="email" className='text-sm font-medium block mb-2 text-gray-300'>
                Your Email
            </label>
            <input type="email" name="email" id='email' className=' border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 
